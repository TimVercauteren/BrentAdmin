    ...
    public class OfferteGenerator : IOfferteGenerator
    {
        ...
        public byte[] FillTemplateWithOfferteData(OfferteDTO dataObject)
        {
            ...
            try
            {
                ...
                sheet.Cell(OfferteDTO.TypeCell).Value = "Offerte";
                sheet.Cell(OfferteDTO.ItemFactuurCell).Value = "";
                sheet.Cell(OfferteDTO.ItemFactuurPrijsCell).Value = "";
                ...
                sheet.Cell(OfferteDTO.Items1PrijsCell).Value = dataObject.Item1Prijs;
                sheet.Cell(OfferteDTO.Items2PrijsCell).Value = dataObject.Item2Prijs;
                sheet.Cell(OfferteDTO.Items3PrijsCell).Value = dataObject.Item3Prijs;
                sheet.Cell(OfferteDTO.Items4PrijsCell).Value = dataObject.Item4Prijs;
                sheet.Cell(OfferteDTO.Items5PrijsCell).Value = dataObject.Item5Prijs;
                sheet.Cell(OfferteDTO.Items6PrijsCell).Value = dataObject.Item6Prijs;
